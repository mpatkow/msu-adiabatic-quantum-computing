...
r_values = [1]
sigma_values = [3.3] #[3.3] #[17.984] #[164] # using 3.3 for the [2,2] case using 5.76 for the [4,4] case. 10.8 for the [8,8] case, 21 for [16,16] case, 82 for [64,64], 164 for [128,128]
i = 0
