...
adiabatic_times = np.linspace(0,40,21)
# adiabatic_times = [0]
#r_values = [int(j) for j in np.linspace(1,1,1)]
r_values = [0,1]
sigma_values = [2,4,6,8,10] #[17.984] #[164] # using 3.3 for the [2,2] case using 5.76 for the [4,4] case. 10.8 for the [8,8] case, 21 for [16,16] case, 82 for [64,64], 164 for [128,128]
i = 0
