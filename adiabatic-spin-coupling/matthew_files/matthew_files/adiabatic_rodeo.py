...
def adiabatic_rodeo_run(ar_params):
    ...
    M_i = xxzhs.AdiabaticHamiltonian(ar_params['special_xxzmodel_params'] | {"adiabatic_time":ar_params['adiabatic_params']['adiabatic_time']})

    # Final/Target Hamiltonian
    M_f = xxzhs.FermiHubbardChain(ar_params['special_xxzmodel_params'])
